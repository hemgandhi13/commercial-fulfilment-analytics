...
- [x] **Batch 2.2 — Correct field-parameter binding shape captured + reference line template** (commit `3dbb323`)
  ...
  - Page 02 test chart `de197928e9dd6a8eab08` (Desktop-authored, bar chart "Net Sales by Shipping Mode") is still on the page — delete or repurpose at the start of Batch 4 (Page 02 work).
